...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', 'Website Resmi Desa ' . ($profilDesa->nama_desa ?? 'Digital') . ' - Informasi dan layanan desa dalam genggaman')">
    <meta name="keywords"
        content="@yield('meta_keywords', 'desa digital, pemerintahan desa, ' . ($profilDesa->nama_desa ?? 'desa') . ', layanan desa, berita desa, UMKM desa')">
    ...
    <meta property="og:title"
        content="{{ $profilDesa->nama_desa ?? config('app.name') }} - @yield('title', 'Website Resmi')">
    <meta property="og:description"
        content="@yield('meta_description', 'Website Resmi Desa ' . ($profilDesa->nama_desa ?? 'Digital') . ' - Informasi dan layanan desa dalam genggaman')">
    <meta property="og:image"
        content="{{ $profilDesa->logo ? Storage::url($profilDesa->logo) : asset('images/default-logo.png') }}">
