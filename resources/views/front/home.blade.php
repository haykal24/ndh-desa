        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 group relative"
                ...
                <div class="p-6">
                    ...
                    <!-- Label -->
                    <p class="text-sm text-gray-500 mt-1 group-hover:text-gray-700 transition-colors duration-300">Total
                        Penduduk Desa</p>

                    <!-- Decorative Element -->
                    <div class="w-12 h-1 bg-emerald-200 rounded-full mt-4 group-hover:w-20 transition-all duration-500">
                    </div>
                </div>
            </div>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'sambutan' }"
            ...
            <div class="flex justify-center mb-6">
                <div class="inline-flex bg-white/90 backdrop-blur-sm rounded-full p-1 shadow-md">
                    ...
                    @if($strukturPemerintahan && ($strukturPemerintahan->prioritas_program ||
                    $strukturPemerintahan->program_kerja))
                    <button @click="activeTab = 'program'" :class="{ 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md': activeTab === 'program',
            ...
            <div class="mt-8 relative">
                <!-- Sambutan Tab Panel -->
                @if($strukturPemerintahan && $strukturPemerintahan->sambutan_kepala_desa)
                <div x-show="activeTab === 'sambutan'" x-transition:enter="transition-all duration-500 ease-out"
                        ...
                        <div class="grid md:grid-cols-12 gap-6 p-6">
                            ...
                            <div class="md:col-span-4 flex flex-col items-center" data-aos="fade-right">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">{{ $strukturPemerintahan->periode_jabatan }}
                                    </p>
                                </div>
                                ...
                                <div class="mt-4 hidden md:flex justify-center">
                                    <div class="flex space-x-1">
                                        @for($i = 0; $i < 5; $i++) <div
                                            class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-bounce"
            ...
            @if($strukturPemerintahan && ($strukturPemerintahan->prioritas_program ||
            $strukturPemerintahan->program_kerja))
            <div x-show="activeTab === 'program'" x-transition:enter="transition-all duration-500 ease-out"
                x-transition:enter-start="opacity-0 transform translate-y-4"
                x-transition:enter-end="opacity-100 transform translate-y-0"
                x-transition:leave="transition-all duration-300 ease-in"
                x-transition:leave-start="opacity-100 transform translate-y-0"
                    ...
                    <div class="flex justify-center mb-5">
                        <div class="inline-flex bg-white/90 backdrop-blur-sm rounded-full p-1 shadow-md">
                            <button @click="activeSubTab = 'prioritas'"
                                ...
                                <svg class="w-4 h-4 mr-1.5" :class="{'text-white': activeSubTab === 'prioritas'}"
                            ...
                            <button @click="activeSubTab = 'programKerja'"
                                ...
                                class="px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center">
                                <svg class="w-4 h-4 mr-1.5" :class="{'text-white': activeSubTab === 'programKerja'}"
                                    viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div x-show="activeSubTab === 'prioritas'"
                            ...
                            <div class="py-10 text-center">
                                ...
                                <p class="text-gray-500 max-w-md mx-auto">Program prioritas pembangunan desa belum
                        ...
                        <div x-show="activeSubTab === 'programKerja'"
                            ...
                            <div class="py-10 text-center">
                                ...
                                <p class="text-gray-500 max-w-md mx-auto">Program kerja desa belum tersedia atau sedang
                                    dalam proses pembaruan.</p>
                            </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="relative aspect-w-16 aspect-h-9 overflow-hidden">
                                ...
                                <img class="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                    src="{{ Storage::url($berita->gambar) }}" alt="{{ $berita->judul }}" loading="lazy">
                    ...
                    <div class="swiper-slide p-3">
                        ...
                        <div
                            ...
                            <div class="relative aspect-w-16 aspect-h-9 overflow-hidden">
                                @if($umkm->foto_usaha)
                                <img class="object-cover w-full h-full transition-transform duration-700 group-hover:scale-105"
                                    src="{{ Storage::url($umkm->foto_usaha) }}" alt="{{ $umkm->nama_usaha }}"
                                    loading="lazy">
                            ...
                            <div class="p-6 flex flex-col flex-grow relative bg-white">
                                ...
                                <div class="flex items-center justify-between mb-4 relative z-10">
                                    ...
                                    <div
                                        ...
                                        <svg class="w-4 h-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
